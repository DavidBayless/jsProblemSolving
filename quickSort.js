...
function generateSeqList(num, rev) {
  var arr = [];
  if (!rev) {
    for (var i = num; i > 0; i--) {
      arr.push(i);
...
console.log(testPerformance(quickSort, generateSeqList(100)));
console.log(testPerformance(quickSort, generateSeqList(1000)));
console.log(testPerformance(quickSort, generateSeqList(10000)));
console.log(testPerformance(quickSort, generateSeqList(100000)));
console.log(testPerformance(quickSort, generateSeqList(1000000)));
console.log(testPerformance(quickSort, generateSeqList(10000000)));
console.log(testPerformance(quickSort, generateSeqList(100000000)));
